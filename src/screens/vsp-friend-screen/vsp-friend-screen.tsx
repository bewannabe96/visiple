	...
	render() {
		return (
			<VSPContainer>
				...
				<ScrollView
					contentContainerStyle={this._fixed_style.friendsView}
				>
	...
	render() {
		return (
			<View style={this._fixed_style.itemView}>
				<VSPProfile marginRight={4 * HORIZONTAL_UNIT} />
				...
				<VSPTextButton icon='next' fontSize={THEME_HEADER_FONTSIZE} />
			</View>
		);
	}
}
					...
					<View style={this._fixed_style.container}>
						<View style={this._fixed_style.headerView}>
							<View style={this._fixed_style.headerTitleView}>
								<VSPText
									style={this._fixed_style.headerTitleText}
								>
									친구 추가
								</VSPText>
							</View>
