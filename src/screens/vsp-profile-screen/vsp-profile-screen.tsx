            ...
            <VSPContainer>
                ...
                <View style={this._fixed_style.summaryView}>
                    <View style={this._fixed_style.summaryItemView}>
                        <VSPText style={this._fixed_style.summaryItemTitleText}>기록</VSPText>
                        <VSPText style={this._fixed_style.summaryItemValueText}>0</VSPText>
                    </View>
                    <View style={this._fixed_style.summarySeperator} />
                    <View style={this._fixed_style.summaryItemView}>
                        <VSPText style={this._fixed_style.summaryItemTitleText}>친구</VSPText>
                        <VSPText style={this._fixed_style.summaryItemValueText}>0</VSPText>
                        </View>
                    <View style={this._fixed_style.summarySeperator} />
                    <View style={this._fixed_style.summaryItemView}>
                        <VSPText style={this._fixed_style.summaryItemTitleText}>팔로워</VSPText>
                        <VSPText style={this._fixed_style.summaryItemValueText}>0</VSPText>
                        </View>
                </View>
